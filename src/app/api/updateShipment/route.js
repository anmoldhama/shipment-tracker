...
//  console.log(payload.username);
  try {
	...
	shipmentstatus = $5,
	planneddeliverydate = $6,
	actualdeliverydate = $7
    where shipmentid = $1;
    `;
    // const values = [payload.email, payload.password];
    const values = [payload.shipmentid, payload.assigneddriverid, payload.customername, payload.destinationaddress, payload.shipmentstatus, payload.planneddeliverydate,payload.actualdeliverydate];
