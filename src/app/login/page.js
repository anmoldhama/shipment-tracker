...
export default function Login() {
  ...
  //             <div className="p-4 max-w-md bg-white rounded shadow-lg" style={{ marginTop: '7%' }}>
...
<div className="py-16">
    ...
    <div className="hidden lg:block lg:w-1/2 bg-cover" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1473445730015-841f29a9490b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fHRydWNrc3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60')" }}>
</div>
        <div className="w-full p-8 lg:w-1/2">
            <h2 className="text-2xl font-semibold text-gray-700 text-center">SHIPMENT TRACKER</h2>
            ...
            <div className="mt-4 flex items-center justify-between">
                ...
                onClick={handleRegistrationClick}>or sign up</a>
                <span className="border-b w-1/5 md:w-1/4"></span>
            </div>
        </div>
    </div>
